...
- [General Utilities](https://github.com/linnovate/blocktree/blob/v2-dev/docs/utils.md): Structured Logger (Pino), Fetch Client, JWT Parsing, and Dynamic Imports.
- [Server Utilities](https://github.com/linnovate/blocktree/blob/v2-dev/docs/server.md): Express middlewares for security (Helmet/CORS), optimization, and Swagger auto-generation.
