 ...
 * @param {Object|null} fetchOptions - Additional options passed directly to the `FetchClient` factory. {@link https://github.com/linnovate/blocktree/blob/v2-dev/docs/utils.md#FetchClient|FetchClient Options Documentation}
 * @param {Object|null} redisOptions - Additional options passed directly to the `RedisClient` factory. {@link https://github.com/linnovate/blocktree/blob/v2-dev/docs/services.md#RedisClient|RedisClient Options Documentation}
 *
